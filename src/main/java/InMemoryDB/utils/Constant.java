...
public final class Constant {
    ...
    static File employeesCSVFile = new File("target/InMemoryDB/WEB-INF/classes/employees.csv");
    public static final String EMPLOYEES_CSV_PATH = employeesCSVFile.getAbsolutePath();
    static File departmentsCSVFile = new File("target/InMemoryDB/WEB-INF/classes/departments.csv");
    public static final String DEPARTMENTS_CSV_PATH = departmentsCSVFile.getAbsolutePath();
    static File usersCSVFile = new File("target/InMemoryDB/WEB-INF/classes/Users.csv");
    public static final String USERS_FILE_PATH = usersCSVFile.getAbsolutePath();
    static File employeesLoggerFile = new File("target/InMemoryDB/WEB-INF/classes/employees_logger.txt");
    public static final String EMPLOYEES_LOGGER_FILE = employeesLoggerFile.getAbsolutePath();
    static File departmentsLoggerFile = new File("target/InMemoryDB/WEB-INF/classes/departments_logger.txt");
    public static final String DEPARTMENTS_LOGGER_FILE = departmentsLoggerFile.getAbsolutePath();
    static File usersLoggerFile = new File("target/InMemoryDB/WEB-INF/classes/users_logger.txt");
